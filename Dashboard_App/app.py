...
with tab2:
    ...
    image3 = Image.open('randforest_model_no_smote.jpg')
    image4 = Image.open('randforest_model_with_smote.jpg')
    ...
    image5 = Image.open('reandom_forest_no_smote_ROC_AUC.jpg')
    image6 = Image.open('reandom_forest_with_smote_ROC_AUC.jpg')
